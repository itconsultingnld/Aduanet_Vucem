...
function excel_insp_almacen($registros)
{
    ...
    header('Content-disposition: attachment; filename="' . XLSXWriter::sanitize_filename('Inspecciones_Recientes.xlsx') . '"');
    ...
    $writer->writeSheetRow('Inspecciones', array('Inspecciones recientes'), $styles2);
    $writer->writeSheetRow('Inspecciones', $row_vacio);
    $writer->writeSheetRow('Inspecciones', array('','Fecha:', $fecha));
    $writer->writeSheetRow('Inspecciones', $row_vacio);
